...
def setup_categories(cfg):
    ...
    SR0b = cfg.add_category("SR0b", label="0 btagged jets, njet5", label_short="0 btag", aux={"cuts": [("LT", ">250"), ("HT", ">500"), ("nJet5", "cut"), ("lepton_sel", "cut"), ("ghost_muon_filter", "cut"), ("JetPt_2", ">80"), ("nDeepJetMediumBTag", "==0"), ("iso_cut", "cut"), ("doubleCounting_XOR", "cut")]})
    ...
    All_Lep = cfg.add_category("All_Lep", label="All_Lep", label_short="All_Lep", aux={"cuts": [("LT", ">250"), ("HT", ">500"), ("nJet", ">=3"), ("ghost_muon_filter", "cut"), ("JetPt_2", ">80"), ("nDeepJetMediumBTag", "==0"), ("iso_cut", "cut"), ("all_hard_lepton", "cut"), ("doubleCounting_XOR", "cut")]})
    All_Signal = cfg.add_category("All_Signal", label="All_Signal", label_short="All_Signal", aux={"cuts": [("LT", ">250"), ("HT", ">500"), ("nJet", ">=3"), ("ghost_muon_filter", "cut"), ("JetPt_2", ">80"), ("nDeepJetMediumBTag", "==0"), ("iso_cut", "cut"), ("all_hard_lepton", "cut"), ("doubleCounting_XOR", "cut")]})
